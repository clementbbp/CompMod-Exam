      ...
      if (RandNum < ((Latitude_m^Sharpness_m)/
        ...
        if(Distance_main > Lat_reject){
          ...
          #Flip the direction of the attitudinal message: contrast effect
            ...
            Info$xi[1] <- (Info$xi[1]) - (range01(Distance_main)) 
          ...
          if (Info$yi[1] >= 0){
            ...
            #pull valence in opposite direction
            Info$yi[1] <- (Info$yi[1]) - (range01(Distance_main)) 
      ...
      if(Social_group$AgentNo[x] %in% Agents$AgentNo){
        ...
        if(Distance_social > Lat_reject){
          ...
          if (Info$xi[2] >= 0){
            ...
            #pull valence in opposite direction
            Info$xi[2] <- (Info$xi[2]) - (range01(Distance_social)) 
        ...
        # "Flip" y
          if (Info$yi[2] >= 0){
            ...
            #pull valence in opposite direction
            Info$yi[2] <- (Info$yi[2]) - (range01(Distance_social)) 
...
Out9 <- ABM1(Agents = Agents20, Iterations = 100, Plot_freq = 10, Bias = "Positive", Social_posting = TRUE) #nPop = 100, nMemo = 20, Lat_accept = 0.3, Sharpness = 5, nGroups = 5, bias positive
