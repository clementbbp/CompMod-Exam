...
ABM1 <- function(Agents, Iterations, Plot_freq, Bias){
  ...
  for(t in 1:Iterations){
   ...
   #Conditional statement for Bias
    ...
    #Maybe put social sharing here, after all agents have tried to integrate mainstream info
...
Out1 <- ABM1(Agents = Agents1, Iterations = 100, Plot_freq = 10, Bias = "Positive")
mean(Out1$x)
sd(Out1$x)
sd(Out1$y)
